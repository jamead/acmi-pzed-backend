...
# Options for SD card image generation
FWK_YOCTO_WIC_XZ_OPT?="--threads=0 -6"
FWK_YOCTO_WKS_FILE?="sdimage-bootpart.wks"
# -------------------------------------------------
...
# @echo "# exported config from FWK makefile; !DO NOT EDIT!" > $(FWK_YOCTO_DIR)/local_pre.conf
  ...
  ifdef FWK_HDF_AUX
	@echo "HDF_AUX=\"${FWK_HDF_AUX}\"" >> $(FWK_YOCTO_DIR)/local_post.conf
  endif
	@echo "WKS_FILE=\"${FWK_YOCTO_WKS_FILE}\"" >> $(FWK_YOCTO_DIR)/local_post.conf
...
# @echo "--read $(FWK_YOCTO_DIR)/local_pre.conf \\" >> $(FWK_YOCTO_DIR)/bitbake_env.sh
	...
	@echo "export BB_ENV_EXTRAWHITE='IMAGE_FSTYPES'" >> $(FWK_YOCTO_DIR)/bitbake_env.sh
...
yocto_sdcard: yocto_env
	$(YOCTO_ENV) IMAGE_FSTYPES="wic.xz" bitbake $(FWK_YOCTO_IMAGE)
